...
def bulletime(cars, maximum_t = 100, minimum_t=0.1): #muss immer unterschätzen aber nie meher als min_abstand zwischen zwei punkten
    """
        ...
        while len(self.open_list)>0:
            ...
            for node in next_nodes:
                ...
                #    print("t_crash " + str(t_min))
                    ...
                    new_nodes = last_node_befor_crash.expand_next_senarios()
